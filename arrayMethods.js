...
const orderTotals = orders.map(total => total.price+(total.price*total.tax))
...
// CODE HERE
const bobsTotal = purchases.filter(element => element.owner === 'Bob').reduce((total, current) => total+current.price,0)
